...
if __name__ == "__main__":
    ...
    loss_func = lambda o, t: F.binary_cross_entropy(o, t) # + F.los(o, t) * regular_lambda
    ...
    train_set_loader, val_set_loader, test_set_loader = get_multiclass_dataset_loader(batch_size, 
                                                                                      n_classes=1, 
                                                                                      class_select=["CWE-476"], 
                                                                                      verbose=True,
                                                                                    )
    # train_set_loader, val_set_loader, test_set_loader = get469(8, batch_size, verbose=True)
